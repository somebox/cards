...
- Add one paragraph to `docs/reference/DEVELOPER-REFERENCE.md` documenting
...
`Board.Settings` (see `SPEC-DATA-MODEL.md` §Board Settings).
...
4. **Historical misattribution.** Do not rewrite; accept the honesty gap;
   date the flag day in `NOTES.md`. Decide if the demo workspace's seeded
...
2026-07-10** (see `docs/NOTES.md` freeze entry). From that date they change
...
7. **NOTES.md flag-day entry** — one bullet when auth activation lands,
...
- `docs/spec/SPEC-API-SURFACE.md` (§§ users, actor; gains
  "Security / Actor" subsection when AUTH.md's reference impl lands)
- `docs/spec/SPEC-DATA-MODEL.md` (User, WorkspaceSettings)
- `docs/architecture/ARCHITECTURE.md`
- `docs/architecture/DESIGN.md` (the web UI's own design contract — the
  reference client's charter)
- `docs/reference/DEVELOPER-REFERENCE.md` (gains the "optional
