...
**Required supporting change:** `EVENTS.md` gains a **versioned per-type
...
## 11. Delivery taxonomy (to complete in EVENTS.md §9)
...
Also reconcile EVENTS.md §8.6: escalated-condition restart duplication compounds
...
1. `EVENTS.md` per-type durability column + §9 taxonomy (paper, no code).
