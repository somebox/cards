<!-- rollout.md — deployment and rollout for the event system.
     See index.md for the index. -->
...
- **3e — temporal conditions `[built]`.** `status_timeout`/`card_idle` wired
  ...
  yet include temporal items — deferred (noted in design-notes.md), not required by
  this milestone.
