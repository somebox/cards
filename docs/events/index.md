...
Related: [`integration.md`](../events/integration.md), [`index.md`](../spec/index.md),
[`index.md`](../architecture/index.md), [`philosophy.md`](../concepts/philosophy.md).

---

> **Current status (2026-07):** Steps 1–3 implemented and merged
> (seam hardening, board scope, condition events). Step 4 (outbox/tailer)
> future. See `rollout.md` §12 for the authoritative per-step
> status and `core.md` for the conceptual reference.
...
- [core.md](core.md) — conceptual reference (§1–§11)
- [rollout.md](rollout.md) — deployment and rollout (§12–§13)
