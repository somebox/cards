...
| Doc | Contents |
|-----|----------|
| [Concepts](index.md) | Vocabulary and the reasoning behind Cards |
| [The workflow](../using-cards.md) | How a project runs on Cards day to day |
| [Specification](../spec/index.md) | Normative behavior and API |
| [Built vs proposed](../reference/implementation-status.md) | Code-verified audit of what's implemented |
| [Extensions](../extensions/index.md) | Hooks, services, and runs |
| [Architecture](../architecture/index.md) | The Go core and packaging |
