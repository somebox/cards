...
[`design-notes.md`](../design-notes.md) for the full change log and rationale. The core
...
- [3. Workspace, storage, and deployment & 4. Core data model](data-model.md)
- [6. Field types & 7. Card-type examples](card-types.md)
- [8. History, events, and retention & 12. Actors and authorization](events-history.md)
- [9. Query and filter DSL & 10. Validation and anti-hallucination](query-dsl.md)
- [5. Schema versioning, 11. API surface, 13. Agent ergonomics, 14. Open questions & 15. Core vs extensions](api-surface.md)
