...
[`ARCHITECTURE.md`](../architecture/ARCHITECTURE.md)), but the result is a single workspace
...
> [`EVENTS.md`](../events/EVENTS.md)). Treat this subsection as the design contract,
