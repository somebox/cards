...
Normative product behavior lives in [`index.md`](../spec/index.md); the principles
behind these choices live in [`philosophy.md`](../concepts/philosophy.md); the extension
contract lives in [`index.md`](../extensions/index.md); schema authoring lives in
[`workspace-and-boards.md`](../reference/workspace-and-boards.md); the vocabulary and mental
model live in [`index.md`](../concepts/index.md). For a code-verified drift audit of
the claims in this document (which features are built vs. proposed), see
[`implementation-status.md`](../reference/implementation-status.md); for the events subsystem
design, see [`index.md`](../events/index.md).
...
See [`index.md`](../extensions/index.md) for the declaration format and
...
- `command` field type was **removed** from the core (see `design-notes.md` D2);
...
- Mirror import is version-gated: each markdown file declares the `version` it
  ...
  overwrite (see `index.md` §3). **[planned, not yet implemented]**
