...
with the removed `command` field type — see `design-notes.md` D2/D18.)
...
> implemented** (see [`index.md`](../architecture/index.md)'s planned
...
[`data-model.md` §4](../spec/data-model.md)). Validation of richer
...
| [`index.md`](../spec/index.md) | Normative API and event types |
| [`index.md`](../architecture/index.md) | Go core, packaging, supervisor |
| [`lifecycle-schema.md`](../architecture/lifecycle-schema.md) | Autostart × RestartPolicy × kinds; bimodal supervisor |
| [`card-definitions.md`](../reference/card-definitions.md) | Card definitions (schema authoring) |
| [`index.md`](../examples/index.md) | End-to-end lifecycles |
