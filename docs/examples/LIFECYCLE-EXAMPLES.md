...
- [Shared Setup & Cross-Cutting Behaviors](LIFECYCLE-EXAMPLES-SETUP.md)
- [Example A — Software delivery board walkthrough](LIFECYCLE-EXAMPLES-SOFTWARE.md)
- [Example B — Shop floor / CNC board walkthrough](LIFECYCLE-EXAMPLES-SHOPFLOOR.md)
