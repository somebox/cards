...
//
// See docs/spec/api-surface.md (§11 API surface) and
// docs/architecture/index.md (Core Service Boundary). UI is a reference consumer, not part of the kernel.
package httpapi
...
func New(svc *core.Service, ws *core.Workspace, types map[string]*core.CardType, boards map[string]*core.Board, themes map[string]*core.Theme, st core.Store) (*Server, error) {
	...
	pageSets := map[string][]string{
		...
		"board_create.html":   {"templates/board_create.html", "templates/field_control.html"},
