...
func (s *Server) Router() http.Handler {
	...
	r.Post("/v1/cards", s.idempotent(s.withActor(s.apiCreateCard)))
	...
	r.Patch("/v1/cards/{id}/comments/{commentID}", s.idempotent(s.withActor(s.apiEditComment)))
	r.Post("/v1/cards/{id}/fields/{field}/append", s.idempotent(s.withActor(s.apiAppendEntry)))
	r.Patch("/v1/cards/{id}/fields/{field}/{entryID}", s.idempotent(s.withActor(s.apiUpdateEntry)))
