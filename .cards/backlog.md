...
<!-- generated by pi-cards export from the cards workspace "demo" as of 2026-07-22T16:52:42.229742Z — do not edit by hand; regenerate with /cards export -->

201 card(s). Columns in board order; cards oldest-first.
...
| **0fd1b9b7**<br>programming-task | Sprint 07-22 P5: schema-authoring UI — create-first, additive-safe (one schema,… | Sprint 07-22 Phase 5 of docs/plans/2026-07-22-sprint-plan.md — make "one schema drives every… |
| **ad67971f**<br>programming-task | Sprint 07-22 P4: pin contracts (OpenAPI structural, error paths, SSE… | Sprint 07-22 Phase 4 of docs/plans/2026-07-22-sprint-plan.md — pin the widest contract-bearing… |
| **57e1bde9**<br>programming-task | Sprint 07-12 P3: reader pool (or write-hold reduction), proven on… | PLAIN: today every read queues behind one write connection; this card ships a reader pool (or, if… |
...
| **495d2e09**<br>infra-task | Sprint 07-12 P2b: measured file-WAL read-under-write… | Phase 2 of docs/archive/2026-07-sprints/sprint-2026-07-12.md — the measured baseline that decides… |
| **469c93e2**<br>programming-task | Docs example: changelog generated from cards… | Small scripts/changelog.sh + docs snippet: cards closed since the last tag, grouped by the `kind`… |
...
| **3fd62d32**<br>api-task | Sprint 07-22 P2: POST /v1/cards/query — decided contract +… | Sprint 07-22 Phase 2 of docs/plans/2026-07-22-sprint-plan.md — the sprint's early user win, pulled… |
...
| **670dab61**<br>programming-task | Sprint 07-22 P1: foundation hygiene — write-seam… | Sprint 07-22 Phase 1 of docs/plans/2026-07-22-sprint-plan.md — cheap, verdict-independent cleanups… |
