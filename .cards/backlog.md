...
<!-- generated by pi-cards export from the cards workspace "demo" as of 2026-07-23T02:09:56.866616Z — do not edit by hand; regenerate with /cards export -->

205 card(s). Columns in board order; cards oldest-first.
...
| **c7a70b64**<br>programming-task | SPLIT PARENT: re-home P2 residual bag (date min/max done; 3 concerns… | SPLIT PARENT — was a cross-sprint residual grab-bag. The date-min/max bullet shipped (sprint 07-18… |
| **069ec1d1**<br>api-task | CLI: patch/claim without a preceding GET (--if-match latest… | Problem: `cards patch` and `cards claim` REQUIRE `--version` (commands.go:168, :239), so every… |
| **b4190873**<br>programming-task | Docs: normative SPEC for schema-driven UI (FieldDef.display,… | RE-SCOPED to remaining normative work. Much of the original scope already landed in code +… |
| **f6ed4e10**<br>programming-task | Tags: management tooling (CLI/UI) + propose flow + tag_policy UX ·… | P1 — fixes the 'tag_set too small to categorize workstreams' pain. |
| **0707a008**<br>programming-task | UI: board settings editor MVP (columns, types, theme, WIP limits) ·… | Edit an existing board's definition from the UI (not hand-edited JSON). |
| **b3e07b9d**<br>programming-task | UI: expand link chips to reveal target cards (hover/preview) · #feature | **Problem (validated):** on the board view, card links are shown only as COUNT stats —… |
...
| **f570b35b**<br>programming-task | Design RFC: transitions-as-callbacks + trigger seam… | PLAIN: today the core both declares transition rules (data) and enforces them (code). This RFC… |
| **d25f1975**<br>frontend-task | UI chore: split components.js into board / fields / forms / feed… | PLAIN: components.js is one ~1014-line file of Alpine factories. Split it into a few classic… |
| **8fea3fc0**<br>frontend-task | a11y: enforce type/option accent contrast floor on… | PLAIN: type-name badges paint text in the author's accent color, and several shipped accents fail… |
| **34e45cd9**<br>frontend-task | UI: manual reorder within a lane (needs rank-field design) | PLAIN: let a user drag a card to a new position within a lane and have it stay there across reloads… |
| **8903f9aa**<br>frontend-task | UI: /ui/definitions — read-only JSON view of authored… | PLAIN: add a read-only /ui/definitions page that shows the authored definition files (workspace,… |
| **fa6d5c2f**<br>programming-task | Extension example: PR sync - move linked card on merge | Shippable example extension: watch GitHub (a webhook service or a GitHub Action running the CLI)… |
| **b3079e56**<br>programming-task | TRACKER: Sprint 07-12 — honest ledger + SQLite… | SPRINT TRACKER (parent) — not an implementation card. Do not implement work here; drive and close… |
| **ad67971f**<br>programming-task | Sprint 07-22 P4: PR-sync composition (committed) + contract stretch… | Sprint 07-22 Phase 4 — docs/plans/2026-07-22-sprint-plan.md (revised). |
| **0fd1b9b7**<br>programming-task | Sprint 07-22 P5 (stretch): schema UI — create-only ⛔#670dab61 #3fd62d32 | Sprint 07-22 Phase 5 — STRETCH ONLY (docs/plans/2026-07-22-sprint-plan.md). |
| **469c93e2**<br>programming-task | Docs example (stretch): changelog from cards — type_id… | STRETCH (Sprint 07-22 Phase 4 optional) — docs/plans/2026-07-22-sprint-plan.md. |
| **495d2e09**<br>infra-task | Sprint 07-22 P3a: file-WAL baseline + a/b/c verdict… | Sprint 07-22 Phase 3a (committed) — docs/plans/2026-07-22-sprint-plan.md. |
| **57e1bde9**<br>programming-task | Sprint 07-22 P3b (stretch): reader pool / park — post-verdict… | Sprint 07-22 Phase 3b — STRETCH (docs/plans/2026-07-22-sprint-plan.md). |

### todo (11)

| Card | Title | Summary |
|---|---|---|
| **81086204**<br>programming-task | Home & app-nav polish: counts, wayfinding, brand mark · #feature | Make the workspace home and top nav feel like a finished product shell — so someone opening Cards… |
| **86515fd2**<br>programming-task · jeremy | Wave (closing map): post-rebuild UI polish — must-ship done; two… | TRACKER / CLOSING MAP — not a single implementation task. |
| **51c0facf**<br>programming-task | Docs: close Alpine/Pinemix ADR gaps (design-system already holds most… | Most decisions this card wanted are already the lasting contract in… |
| **3fd62d32**<br>api-task | Sprint 07-22 P2: POST /v1/cards/query — decided contract +… | Sprint 07-22 Phase 2 (committed user win) — docs/plans/2026-07-22-sprint-plan.md. |
| **670dab61**<br>programming-task | Sprint 07-22 P1: foundation hygiene — MCP doc, DoD on… | Sprint 07-22 Phase 1 of docs/plans/2026-07-22-sprint-plan.md — enabling work only (no user demo). |
| **c9574816**<br>programming-task · foz | UI: drag-drop target must be the column, not cards · #bug | Bug: drop target is .card-aware so an empty destination column can't accept a drop (no card to… |
| **75307630**<br>programming-task | Sprint 07-22 follow-up A: commit revised plan +… | Follow-up from review of commits cac6b6b, e7fe97e, 3d8a618 (see attached plan). |
| **18006a01**<br>programming-task | Sprint 07-22 follow-up B: card comment/link hygiene (post… | Follow-up from sprint plan revision (post 3d8a618). Parent: Sprint 07-22 tracker. |
| **9c5581c8**<br>programming-task | Sprint 07-22 follow-up C: TUI godoc + tui-screenshots… | Small quality debt from cac6b6b (TUI tests) and e7fe97e (screenshots). |
| **e12fbd0c**<br>programming-task | Sprint 07-22 follow-up D: roll implementation-status audit… | implementation-status.md audit boundary is frozen at bb6ffc5 → 67e613f; HEAD is three commits ahead… |
| **4c5326d4**<br>programming-task | TRACKER: Sprint 07-22 — Solid Substrate, Demonstrated… | SPRINT TRACKER (parent) — not an implementation card. Do not implement work here; drive and close… |

### review (5)

| Card | Title | Summary |
|---|---|---|
| **b01ee035**<br>programming-task · foz | Schema: drop unused programming-task fields… | Measured field population across the 46 programming-task cards: pull_request_url 0/46,… |
| **5008ee9d**<br>programming-task · foz | Docs: CONCEPTS.md — workspaces/boards/card definitions +… | New docs/CONCEPTS.md defining the vocabulary (workspace, definitions, card types, cards, boards)… |
| **e79fb682**<br>programming-task · foz | Core/Board: enforce board default_filter (parsed but never… | Board.default_filter was declared + documented (SPEC §9) but applyBoardScope never applied it, so… |
| **e5952a89**<br>programming-task · foz | Core/Schema: upgrade-schema + migrations (field_defaults) | Implement SPEC §6 schema upgrade: CardType.Migrations (target->{from,summary,field_defaults});… |
| **ded1a923**<br>research-goal · foz | Evaluate SQLite FTS5 vs LIKE for POC scale |  |
...
| **57901d57**<br>programming-task · pi | pi-cards dogfood probe (no-op): e2e confirmed | ## What this is |
...
| **cc469ca0**<br>programming-task · foz | Sprint 07-19 P1: SoT refresh + anchor guard… | ## What shipped |
| **5628c87b**<br>programming-task · foz | Sprint 07-19 P2: JSONL snapshot residual gaps (CLI wrapper,… | ## What shipped |
| **db5b3383**<br>programming-task · foz | Sprint 07-19 P3: Runnable cards-extension seed… | ## What shipped |
| **cf3ba12a**<br>programming-task | TRACKER: Sprint 07-19 — verifiable contracts self-checking… | ## What shipped (sprint summary) |
| **e3103027**<br>programming-task · foz | Sprint 07-19 P4: TUI filter/sort parity (shared… | ## What shipped |
...
| **700b2dfe**<br>programming-task · jeremy | Export bundle: cards export --with-artifacts (portable… | ## What shipped |
| **c4de5e9f**<br>programming-task | v0.2.0 polish: version in web UI + --help, labels… | ## What shipped |
| **30026459**<br>infra-task · jeremy | release workflow: clear the Node 20 deprecation warnings… | ## What shipped |
| **8c04883d**<br>programming-task · foz | Harden transition_illegal error | Ensure valid_options are board column ids, not workspace ids. |
| **b86c7fe9**<br>programming-task · foz | Ergonomics: zero-config start — cards init, .cards/… | Make Cards easy to start (the genesis of the workspace-concepts thread). Git-like model: `cards`… |
